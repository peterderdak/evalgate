...
- [config.evalgate.json](./examples/ticket-triage/config.evalgate.json): default config
- [demo-pass.evalgate.json](./examples/ticket-triage/demo-pass.evalgate.json): passing demo gate
- [demo-fail.evalgate.json](./examples/ticket-triage/demo-fail.evalgate.json): intentionally failing demo gate
