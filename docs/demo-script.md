...
- dataset: [datasets/sample-support-tickets.jsonl](./datasets/sample-support-tickets.jsonl)
- pass config: [docs/demo-pass.evalgate.json](./docs/demo-pass.evalgate.json)
- fail config: [docs/demo-fail.evalgate.json](./docs/demo-fail.evalgate.json)
...
Open [datasets/sample-support-tickets.jsonl](./datasets/sample-support-tickets.jsonl).
...
Open [docs/demo-pass.evalgate.json](./docs/demo-pass.evalgate.json).
...
Open [demo-pass-report.json](./.artifacts/demo-pass-report.json).
...
Open [docs/demo-fail.evalgate.json](./docs/demo-fail.evalgate.json).
...
Open [demo-fail-report.json](./.artifacts/demo-fail-report.json).
